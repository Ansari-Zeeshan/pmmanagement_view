...
export const HelpSupportModal = () => {
  ...
  const [ticketDepartment, setTicketDepartment] = useState('IT PMO & Governance');
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <div className="d-flex align-items-center gap-2">
                ...
                <span className="badge rounded-pill text-white px-2 py-1 small fw-semibold" style={{ backgroundColor: 'rgba(255, 255, 255, 0.16)', border: '1px solid rgba(255, 255, 255, 0.25)' }}>
                  Emaar Assistance
                </span>
              </div>
        ...
        <div className="flex-grow-1 p-3 p-md-4 help-modal-body bg-light" style={{ backgroundColor: '#f8fafc', overflowY: 'auto' }}>
                    ...
                    <div className="card h-100 video-card rounded-4 overflow-hidden bg-white">
                      ...
                      >
                        <div className="d-flex align-items-center justify-content-between">
                          <span className="badge rounded-pill text-white px-2 py-1 small" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)', backdropFilter: 'blur(4px)', border: '1px solid rgba(255, 255, 255, 0.3)' }}>
                            {vid.category}
                          </span>
                          <span className="badge rounded-pill bg-dark bg-opacity-60 text-white font-monospace small px-2 py-1">
                            {vid.duration}
                          </span>
                        </div>
                ...
                {filteredFaqs.map((faq) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="d-flex align-items-center gap-3">
                          ...
                          <div className="d-flex align-items-center gap-2 flex-wrap">
                            <span className="badge rounded-pill bg-primary bg-opacity-10 text-primary border border-primary border-opacity-20 px-2 py-1" style={{ fontSize: '11px', fontWeight: 600 }}>
                              {faq.category}
                            </span>
                      ...
                      {isExpanded && (
                        <div className="px-3 px-md-4 pb-4 pt-2 border-top bg-light-subtle">
                          ...
                          <div className="pt-3 mt-3 border-top d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div className="d-flex align-items-center gap-2">
                              <button
                                type="button"
                                className={`btn btn-sm py-1 px-3 rounded-2 d-inline-flex align-items-center gap-1 fw-medium ${feedbackState === 'yes' ? 'btn-success text-white' : 'btn-outline-secondary bg-white'}`}
                              ...
                              <button
                                type="button"
                                className={`btn btn-sm py-1 px-3 rounded-2 d-inline-flex align-items-center gap-1 fw-medium ${feedbackState === 'no' ? 'btn-danger text-white' : 'btn-outline-secondary bg-white'}`}
                                style={{ fontSize: '12.5px' }}
          ...
          {activeTab === 'TICKET' && (
            <div className="bg-white p-3 p-md-4 rounded-4 border shadow-sm flex-grow-1 d-flex flex-column justify-content-between">
              {!submittedTicketData ? (
                <form onSubmit={handleSubmitTicket} className="d-flex flex-column justify-content-between h-100">
                  <div>
                    <div className="d-flex flex-wrap align-items-center justify-content-between mb-3 border-bottom pb-2.5 gap-2">
                      <div>
                        <h5 className="fw-bold text-dark m-0" style={{ fontSize: '18px', color: '#0f172a', letterSpacing: '-0.3px' }}>
                          Raise a Support Ticket
                        </h5>
                        <p className="text-muted small m-0 mt-0.5" style={{ fontSize: '12px' }}>
                          Our IT PMO Support Team will review your issue and respond within 2 to 4 business hours.
                        </p>
                      </div>
                      <span className="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-20 px-3 py-1 rounded-pill fw-bold" style={{ fontSize: '11.5px' }}>
                        24/7 PMO Helpdesk
                      </span>
                    </div>

                    <div className="row g-3">
                      {/* ROW 1: 2 Columns - Category & Priority */}
                      <div className="col-12 col-md-6">
                        <label className="form-label fw-semibold text-dark small mb-1.5 d-block" style={{ fontSize: '12.5px' }}>
                        ...
                        <FormControl fullWidth size="small" sx={{ width: '100%' }}>
                          ...
                          >
                            <MenuItem value="Technical Bug / System Error" sx={{ fontSize: '13px' }}>Technical Bug / System Error</MenuItem>
                            <MenuItem value="Access & Permissions" sx={{ fontSize: '13px' }}>Access & Permissions Request</MenuItem>
                            <MenuItem value="Data / Project Correction" sx={{ fontSize: '13px' }}>Data / Project Correction</MenuItem>
                            <MenuItem value="Workflow & Approval Query" sx={{ fontSize: '13px' }}>Workflow & Approval Query</MenuItem>
                            <MenuItem value="Feature Request / Enhancement" sx={{ fontSize: '13px' }}>Feature Request / Enhancement</MenuItem>
                          </Select>
                        </FormControl>
                      </div>
                      ...
                      <div className="col-12 col-md-6">
                        ...
                        <FormControl fullWidth size="small" sx={{ width: '100%' }}>
                          ...
                          >
                            <MenuItem value="Low" sx={{ fontSize: '13px' }}>Low (General Inquiry)</MenuItem>
                            <MenuItem value="Medium" sx={{ fontSize: '13px' }}>Medium (Standard Request)</MenuItem>
                            <MenuItem value="High" sx={{ fontSize: '13px' }}>High (Impacting Project Timeline)</MenuItem>
                            <MenuItem value="Urgent" sx={{ fontSize: '13px' }}>Urgent (Critical System Blocker)</MenuItem>
                          </Select>
                        </FormControl>
                      </div>

                      {/* ROW 2: 2 Columns - Project Ref & Contact Email */}
                      <div className="col-12 col-md-6">
                        <label className="form-label fw-semibold text-dark small mb-1.5 d-block" style={{ fontSize: '12.5px' }}>
                        ...
                        <input
                          type="text"
                          className="form-control help-form-input w-100"
                          style={{ height: '44px', fontSize: '13px', width: '100%' }}
                      ...
                      {/* ROW 3: 2 Columns - Subject Title & Department / Module */}
                      <div className="col-12 col-md-6">
                        <label className="form-label fw-semibold text-dark small mb-1.5 d-block" style={{ fontSize: '12.5px' }}>
                      ...
                      <div className="col-12 col-md-6">
                        <label className="form-label fw-semibold text-dark small mb-1.5 d-block" style={{ fontSize: '12.5px' }}>
                          Department / System Module (Optional)
                        </label>
                        <FormControl fullWidth size="small" sx={{ width: '100%' }}>
                          <Select
                          ...
                          >
                            <MenuItem value="IT PMO & Governance" sx={{ fontSize: '13px' }}>IT PMO & Governance</MenuItem>
                            <MenuItem value="Project Management & Strategy" sx={{ fontSize: '13px' }}>Project Management & Strategy</MenuItem>
                            <MenuItem value="Civil Engineering & Infrastructure" sx={{ fontSize: '13px' }}>Civil Engineering & Infrastructure</MenuItem>
                            <MenuItem value="Finance & Budgeting" sx={{ fontSize: '13px' }}>Finance & Budgeting</MenuItem>
                            <MenuItem value="Quality Assurance & Compliance" sx={{ fontSize: '13px' }}>Quality Assurance & Compliance</MenuItem>
                          </Select>
                        </FormControl>
                      </div>

                      {/* ROW 4: 2 Columns - Description & Attachments */}
                      <div className="col-12 col-md-6">
                        <label className="form-label fw-semibold text-dark small mb-1.5 d-block" style={{ fontSize: '12.5px' }}>
                          Detailed Description & Steps to Reproduce <span className="text-danger">*</span>
                        </label>
                        <textarea
                          className="form-control help-form-textarea w-100"
                          rows={3}
                          style={{ minHeight: '110px', height: '110px', fontSize: '13px', padding: '10px 14px', width: '100%' }}
                      ...
                      <div className="col-12 col-md-6">
                        ...
                        <div
                          className="border-2 border-dashed rounded-3 p-3 text-center bg-light transition-all d-flex flex-column align-items-center justify-content-center w-100"
                          style={{ borderColor: '#93c5fd', cursor: 'pointer', backgroundColor: '#f8fafc', height: '110px', width: '100%' }}
                          onClick={() => document.getElementById('ticket-file-input').click()}
                        >
                          <Upload size={22} className="text-primary mb-1" />
                          <div className="fw-semibold text-dark extra-small cursor-pointer" style={{ fontSize: '12px' }}>Click to browse or drop files here</div>
                          <div className="text-muted extra-small mt-0.5" style={{ fontSize: '10.5px' }}>
                        ...
                        {ticketFiles.length > 0 && (
                          <div className="mt-2 d-flex flex-wrap gap-1 overflow-hidden" style={{ maxHeight: '32px' }}>
                            {ticketFiles.map((file, idx) => (
                              <span key={idx} className="badge bg-white text-dark border shadow-xs d-inline-flex align-items-center gap-1 py-1 px-2 rounded-2" style={{ fontSize: '11px' }}>
                                <FileText size={12} className="text-primary" />
                                <span className="fw-medium text-truncate" style={{ maxWidth: '100px' }}>{file.name}</span>
                                <X size={12} className="text-danger cursor-pointer ms-0.5" onClick={(e) => { e.stopPropagation(); removeFile(idx); }} />
                              </span>
                            ))}
                          </div>
                        )}
                  ...
                  <div className="mt-3 pt-2 border-top d-flex align-items-center justify-content-end gap-3">
                    <button
                      type="button"
                ...
                <div className="text-center py-4 px-2">
                  ...
                  <div className="card bg-light border p-3 my-4 mx-auto text-start rounded-3" style={{ maxWidth: '520px', borderColor: '#e2e8f0' }}>
                    ...
                    <div className="d-flex align-items-center justify-content-between mb-1">
                      ...
                      <span className="badge bg-warning bg-opacity-20 text-dark border border-warning px-2 py-1 small">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <span className="badge bg-info bg-opacity-10 text-info border px-2 py-1 small">
