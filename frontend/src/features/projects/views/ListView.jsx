                                  ...
                                  <table className="table table-borderless align-middle m-0" style={{ tableLayout: 'fixed', minWidth: '780px', width: '100%' }}>
                                    <thead>
                                      <tr style={{ backgroundColor: '#ffffff', borderBottom: '1px solid #f1f5f9', height: '40px' }}>
                                        <th className="ps-4 text-dark fw-bold position-sticky start-0 bg-white" style={{ fontSize: '13px', width: '28%', minWidth: '220px', left: 0, zIndex: 12, backgroundColor: '#ffffff', boxShadow: '2px 0 6px rgba(0,0,0,0.06)' }}>Milestone Name</th>
                                        ...
                                        return (
                                          <React.Fragment key={m.id || mIdx}>
                                            ...
                                            >
                                              ...
                                              <td className="ps-4 py-2 position-sticky start-0" style={{ width: '28%', minWidth: '220px', left: 0, zIndex: 11, backgroundColor: palette.bg, boxShadow: '2px 0 6px rgba(0,0,0,0.06)' }}>
                                                <div
                                                  ...
                                                  <div className="bg-light rounded-3 border p-3">
                                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                                      <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <span className="badge bg-primary bg-opacity-10 text-primary rounded-pill px-2 py-1 font-monospace fw-bold" style={{ fontSize: '11px' }}>
