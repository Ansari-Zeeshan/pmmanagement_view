      ...
      <div className="bg-white rounded-4 p-4 p-md-4.5 shadow-sm border mb-4 print-card" style={{ borderColor: '#e2e8f0' }}>
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-4 pt-4 mt-4 border-top" style={{ borderColor: '#f1f5f9' }}>
          <div className="d-flex flex-wrap align-items-center gap-5">
            <div className="d-flex align-items-center gap-3">
              <img src="/img/client1.jpg" alt="" className="rounded-circle shadow-xs" style={{ width: '38px', height: '38px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/icons/avatar1.svg'; }} />
              <div>
            ...
            <div className="d-flex align-items-center gap-3">
              <img src="/img/client2.jpg" alt="" className="rounded-circle shadow-xs" style={{ width: '38px', height: '38px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/icons/avatar2.svg'; }} />
              <div>
          ...
          <div className="col-12 col-lg-4">
            <div className="bg-white p-4 rounded-4 border shadow-sm mb-4" style={{ borderColor: '#e2e8f0' }}>
              ...
              <div className="d-flex flex-column gap-3">
                ...
                >
                  <img src="/img/client1.jpg" alt="" className="rounded-circle shadow-xs" style={{ width: '42px', height: '42px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/icons/avatar1.svg'; }} />
                  <div>
                ...
                >
                  <img src="/img/client2.jpg" alt="" className="rounded-circle shadow-xs" style={{ width: '42px', height: '42px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/icons/avatar2.svg'; }} />
                  <div>
                    <div className="fw-bold text-dark" style={{ fontSize: '14px' }}>{project.domainLead}</div>
                  ...
                  >
                    <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-1">
                      <div className="d-flex align-items-center gap-2">
                        ...
                        {item.done && (
                          <span className="badge rounded-pill px-2.5 py-1" style={{ backgroundColor: '#ecfdf5', color: '#047857', border: '1px solid #a7f3d0', fontSize: '11px', fontWeight: 600 }}>
                            Completed
                          </span>
                        )}
                        {item.current && (
                          <span className="badge rounded-pill px-2.5 py-1" style={{ backgroundColor: '#eff6ff', color: '#1d4ed8', border: '1px solid #bfdbfe', fontSize: '11px', fontWeight: 600 }}>
                            In Progress
                          </span>
                        )}
                      </div>
                      <span className="badge bg-white text-dark border font-monospace px-2.5 py-1 rounded-2" style={{ fontSize: '12px', fontWeight: 600 }}>
                        {item.date}
                      </span>
                    </div>
          ...
          <div className="d-flex flex-column gap-3">
            {project.activities?.map(act => (
              <div key={act.id} className="d-flex align-items-start gap-3 p-3 bg-light rounded-3 border">
                <img src={act.avatar} alt="" className="rounded-circle shadow-xs" style={{ width: '38px', height: '38px', objectFit: 'cover' }} onError={(e) => { e.target.src = '/icons/avatar1.svg'; }} />
                <div>
