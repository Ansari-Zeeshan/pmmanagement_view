          ...
          <div className="mb-4">
            ...
            <div className="d-flex flex-wrap align-items-center gap-3 p-3 rounded-3 bg-light border">
              <div className="d-flex align-items-center gap-2 pe-3 border-end">
                <img src="/img/client1.jpg" alt="" className="rounded-circle" style={{ width: '32px', height: '32px', objectFit: 'cover' }} onError={(e) => { (e.target as HTMLImageElement).src = '/icons/avatar1.svg'; }} />
                <div>
              ...
              <div className="d-flex align-items-center gap-2 pe-3 border-end">
                <img src="/img/client2.jpg" alt="" className="rounded-circle" style={{ width: '32px', height: '32px', objectFit: 'cover' }} onError={(e) => { (e.target as HTMLImageElement).src = '/icons/avatar2.svg'; }} />
                <div>
              ...
              {[
                ...
                return (
                  <div key={idx} className={`position-relative d-flex align-items-start gap-3 ${isLast ? 'mb-0' : 'mb-3'}`} style={{ zIndex: 2 }}>
                    ...
                    <div
                      className="flex-grow-1 p-2 rounded-3 border"
                      style={{
