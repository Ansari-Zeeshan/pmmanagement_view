import { Calendar, CheckCircle2, Clock, Plus, Trash2, User } from 'lucide-react';
        ...
        <div className="modal-content border-0 shadow-2xl rounded-4 overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
          ...
          <div className="modal-header border-bottom px-4 py-3 bg-light d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-2">
              <span className="badge bg-primary bg-opacity-10 text-primary px-3 py-1 rounded-pill fw-bold" style={{ fontSize: '12px' }}>
                      ...
                      <tbody>
                        {subTasks.map((st) => (
                          <tr key={st.id}>
                            ...
                            <td>
                              <select
                                className="form-select form-select-sm rounded-pill px-2 py-1 fw-semibold border"
