...
export const ITProjectClosurePage = () => {
  ...
  const [lookupModalConfig, setLookupModalConfig] = useState(null); // { open: true, fieldName: 'projectName', title: 'Project Name' }
  const [activeCommentParam, setActiveCommentParam] = useState(null); // { open: true, key: 'ratingSchedule', label: 'Project completion...' }
