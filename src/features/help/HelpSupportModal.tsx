                        ...
                        <div className="px-3 px-md-4 pb-4 pt-2 border-top bg-light-subtle">
                          ...
                          <div className="pt-3 mt-3 border-top d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div className="d-flex align-items-center gap-2">
                              <button
                                type="button"
                                className={`btn btn-sm py-1 px-3 rounded-2 d-inline-flex align-items-center gap-1.5 fw-medium ${feedbackState === 'yes' ? 'btn-success text-white' : 'btn-outline-secondary bg-white'}`}
                              ...
                              <button
                                type="button"
                                className={`btn btn-sm py-1 px-3 rounded-2 d-inline-flex align-items-center gap-1.5 fw-medium ${feedbackState === 'no' ? 'btn-danger text-white' : 'btn-outline-secondary bg-white'}`}
                                style={{ fontSize: '12.5px' }}
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-12 col-md-6">
                        ...
                        {ticketFiles.length > 0 && (
                          <div className="mt-2 d-flex flex-wrap gap-1.5 overflow-hidden" style={{ maxHeight: '32px' }}>
